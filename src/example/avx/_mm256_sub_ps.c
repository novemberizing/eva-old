...
{
    vector256 x = { .f32 = { 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f } };
    vector256 y = { .f32 = { 0.1f, 0.2f, 0.3f, 0.4f, 0.5f, 0.6f, 0.7f, 0.8f } };

    vector256 z = { .f256 = _mm256_sub_ps(x.f256, y.f256) };
