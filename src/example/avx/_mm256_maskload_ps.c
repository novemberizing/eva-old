...
int main(int argc, char ** argv)
{
    vectorf32x8 x[4] = {
        ...
        { 9.9f, 0.0f, 1.1f, 2.2f, 3.3f, 4.4f, 5.5f, 6.6f },
        { 7.7f, 8.8f, 9.9f, 0.0f, 1.1f, 2.2f, 3.3f, 4.4f },
        { 5.5f, 6.6f, 7.7f, 8.8f, 9.9f, 0.0f, 1.1f, 2.2f }
    };

    vector256 mask = { .i32 = { -1, 0, -1, 0, -1, 0, -1, 0 } };

    vector256 z = { .f256 = _mm256_maskload_ps(&x[2][2], mask.i256) };
