...
static float values[] = { 0.0f, 1.1f, 2.2f, 3.3f, 4.4f, 5.5f, 6.6f, 7.7f, 8.8f, 9.9f, 10.1f, 11.11f, 12.12f, 13.13f, 14.14f, 15.15f, 16.16f, 17.17f, 18.18f, 19.19f, 20.20f, 21.21f, 22.22f, 23.23f, 24.24f, 25.25f, 26.26f, 27.27f, 28.28f, 29.29f, 30.30f, 31.31f };

int main(int argc, char ** argv)
{
    vector256 source = { .f32 = { 7.7f, 6.6f, 5.5f, 4.4f, 3.3f, 2.2f, 1.1f, 0.0f } };
    vector256 index = { .i32 = { 2, 4, 6, 8, 10, 12, 14, 16 } };
    vector256 mask = { .u32 = { 0x80000000U, 0, 0x80000000, 0, 0x80000000, 0, 0x80000000, 0 } };
    vector256 z = { .f256 = _mm256_mask_i32gather_ps(source.f256, values, index.i256, mask.d256, 2) };
