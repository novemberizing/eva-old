...
{
    vector128 x = { .u32 = { 0x80000000, 0x80000000, 0x80000000, 0x80000000 } };
    vector128 y = { .u32 = { 0x80000000, 0x80000000, 0x80000000, 0x80000000 } };

    int z =  _mm_testnzc_ps(x.f128, y.f128);
