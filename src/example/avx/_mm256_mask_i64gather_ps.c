...
static float values[] = { 0.0f, 1.1f, 2.2f, 3.3f, 4.4f, 5.5f, 6.6f, 7.7f, 8.8f, 9.9f, 10.1f, 11.11f, 12.12f, 13.13f, 14.14f, 15.15f };

int main(int argc, char ** argv)
{
    vector128 source = { .f32 = { 3.3f, 2.2f, 1.1f, 0.0f } };
    vector256 index = { .u64 = { 2, 4, 6, 8 } };
    vector128 mask = { .u32 = { -1, 0, -1, 0 } };
    vector128 z = { .f128 = _mm256_mask_i64gather_ps(source.f128, values, index.i256, mask.i128, 2) };
