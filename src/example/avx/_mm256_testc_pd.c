...
{
    vector256 x = { .u64 = { 0xFFFF00FF00FF00FFUL, 0xFFFF00FF00FF00FFUL, 0xFF00FF00FF00FF00UL, 0xFF00FF00FF00FF00UL } };
    vector256 y = { .u64 = { 0xFF00FF00FF00FF00UL, 0xFFFF00FF00FF00FFUL, 0xFF00FF00FF00FF00UL, 0xFFFF00FF00FF00FFUL } };

    int z = _mm256_testc_pd(x.d256, y.d256);
