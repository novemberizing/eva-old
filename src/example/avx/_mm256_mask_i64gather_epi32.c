...
{
    vector256 index = { .i64 = { 2, 4, 6, 8 } };
    vector128 source = { .u32 = { 4, 3, 2, 1 } };
    vector128 mask = { .u32 = { -1, 0, -1, 0 } };
    vector128 z = { .i128 = _mm256_mask_i64gather_epi32(source.i128, values, index.i256, mask.i128, 2) };
