...
{
    vector256 x = { .u64 = { 0xFF00FF00FF00FF00UL, 0xFF00FF00FF00FF00UL, 0xFF00FF00FF00FF00UL, 0xFF00FF00FF00FF00UL } };
    vector256 y = { .u64 = { 0x00FF00FF00FF00FFUL, 0x00FF00FF00FF00FFUL, 0xFF00FF00FF00FF00UL, 0xFF00FF00FF00FF00UL } };

    vector256 z = { .i256 = _mm256_xor_si256(x.i256, y.i256) };
