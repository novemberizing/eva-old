...
static double values[] = { 0.0f, 1.1f, 2.2f, 3.3f, 4.4f, 5.5f, 6.6f, 7.7f, 8.8f, 9.9f, 10.1f, 11.11f, 12.12f, 13.13f, 14.14f, 15.15f, 16.16f, 17.17f, 18.18f, 19.19f, 20.20f, 21.21f, 22.22f, 23.23f, 24.24f, 25.25f, 26.26f, 27.27f, 28.28f, 29.29f, 30.30f, 31.31f };

int main(int argc, char ** argv)
{
    vector256 source = { .i64 = { 3, 2, 1, 0 } };
    vector128 index = { .i32 = { 2, 4, 6, 8 } };
    vector256 mask = { .u64 = { 0x8000000000000000UL, 0, 0x8000000000000000UL, 0 } };
    vector256 z = { .d256 = _mm256_i32gather_pd(values, index.i128, 4) };
