...
int main(int argc, char ** argv)
{
    ...
    vectori32x8 base = { 0x000000FF, 0x000000FF, 0x000000FF, 0x000000FF };

    vector128 index = { .i32 = { 1, 2, 1, 2 } };
    vector128 mask = { .i32 = { -1, 0, -1, 0 } };

    vector128 z = { .i128 = _mm_mask_i32gather_epi32(source.i128, &base[0], index.i128, mask.i128, 2) };
