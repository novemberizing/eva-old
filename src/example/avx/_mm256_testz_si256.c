...
{
    vector256 x = { .u64 = { 0x8FFFFFFFFFFFFFFFUL, 0x0000000000000000UL, 0x0000000000000000UL, 0x0000000000000000UL } };
    vector256 y = { .u64 = { 0x7000000000000000UL, 0x0000000000000000UL, 0x0000000000000000UL, 0x0000000000000000UL } };

    int z = _mm256_testz_si256(y.i256, x.i256);
    printf("%08x\n", z);
