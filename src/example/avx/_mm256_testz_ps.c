...
{
    vector256 x = { .u32 = { 0x8FFFFFFF, 0x8FFFFFFF, 0x8FFFFFFF, 0x8FFFFFFF, 0x8FFFFFFF, 0x8FFFFFFF, 0x8FFFFFFF, 0x8FFFFFFF } };
    vector256 y = { .u32 = { 0x70000000, 0x70000000, 0x70000000, 0x70000000, 0x70000000, 0x00000000, 0x70000000, 0x70000000 } };

    int z = _mm256_testz_ps(y.f256, x.f256);
