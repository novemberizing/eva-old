...
{
    vector256 x = { .u64 = { 0xFFFFFFFF00000000UL, 0xEEEEEEEE00000000UL, 0xDDDDDDDD00000000UL, 0xCCCCCCCC00000000UL } };
    vector256 y = { .u64 = { 0x1111111100000000UL, 0x2222222200000000UL, 0x3333333300000000UL, 0x4444444400000000UL } };

    vector256 z = { .i256 = _mm256_unpacklo_epi64(x.i256, y.i256) };
