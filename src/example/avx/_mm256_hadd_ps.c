...
{
    vector256 x = { .f32 = { 0.0f, 1.1f, 2.2f, 3.3f, 4.4f, 5.5f, 6.6f, 7.7f } };
    vector256 y = { .f32 = { 7.7f, 6.6f, 5.5f, 4.4f, 3.3f, 2.2f, 1.1f, 0.0f } };

    vector256 z = { .f256 = _mm256_hadd_ps(x.f256, y.f256) };
