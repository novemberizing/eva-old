...
{
    vector256 x = { .u64 = { 0x7FFFFFFFFFFFFFFFUL, 0x0000000000000000UL, 0x0000000000000000UL, 0x0000000000000001UL } };
    vector256 y = { .u64 = { 0x8000000000000000UL, 0x0000000000000000UL, 0x0000000000000000UL, 0x000000000000000FUL } };

    int z = _mm256_testnzc_si256(x.i256, y.i256);
