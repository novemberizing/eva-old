...
{
    vector256 x = { .u32 = { 0xFF00FF00, 0xFF00FF00, 0xFF00FF00, 0xFF00FF00, 0xFF00FF00, 0xFF00FF00, 0xFF00FF00, 0xFF00FF00 } };
    vector256 y = { .u32 = { 0x00FF00FF, 0x00FF00FF, 0x00FF00FF, 0x00FF00FF, 0xFF00FF00, 0xFF00FF00, 0xFF00FF00, 0xFF00FF00 } };

    vector256 z = { .f256 = _mm256_xor_ps(x.f256, y.f256) };
