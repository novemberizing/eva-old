...
int main(int argc, char ** argv)
{
    ...
    z = _mm_cmpistra(x.i128, y.i128, _SIDD_UBYTE_OPS | _SIDD_CMP_EQUAL_ANY | _SIDD_MASKED_NEGATIVE_POLARITY);
    printf("%08x\n", z);

    z = _mm_cmpistra(x.i128, y.i128, _SIDD_UBYTE_OPS | _SIDD_CMP_RANGES | _SIDD_MASKED_NEGATIVE_POLARITY);
    printf("%08x\n", z);

    z = _mm_cmpistra(x.i128, y.i128, _SIDD_UBYTE_OPS | _SIDD_CMP_EQUAL_EACH | _SIDD_MASKED_NEGATIVE_POLARITY);
    printf("%08x\n", z);

    z = _mm_cmpistra(x.i128, y.i128, _SIDD_UBYTE_OPS | _SIDD_CMP_EQUAL_ORDERED | _SIDD_MASKED_NEGATIVE_POLARITY);
    printf("%08x\n", z);
