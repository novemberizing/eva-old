...
int main(int argc, char ** argv)
{
    ...
    z = _mm_cmpestrz(x.i128, 16, y.i128, 16, _SIDD_UBYTE_OPS | _SIDD_CMP_EQUAL_ANY);
    printf("%08x\n", z);

    z = _mm_cmpestrz(x.i128, 16, y.i128, 16, _SIDD_UBYTE_OPS | _SIDD_CMP_RANGES);
    printf("%08x\n", z);

    z = _mm_cmpestrz(x.i128, 16, y.i128, 16, _SIDD_UBYTE_OPS | _SIDD_CMP_EQUAL_EACH);
    printf("%08x\n", z);

    z = _mm_cmpestrz(x.i128, 16, y.i128, 16, _SIDD_UBYTE_OPS | _SIDD_CMP_EQUAL_ORDERED);
    printf("%08x\n", z);
