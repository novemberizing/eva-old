...
static const int examplestrmax = 128;
static const int experimentalcount = 64;

static char examplestr[128][65536 + 16];
...
extern xuint64 xstringlen_simd(const char * s)
{
