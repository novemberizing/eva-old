`_mm_cmpistri(x: __m128i, y: __m128i, imm8: const int)`
=======================================================

> Compare packed strings with implicit lengths in x and y using the control in imm8, imm can be a combination of:
